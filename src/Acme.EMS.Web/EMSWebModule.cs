...
using Acme.EMS.MultiTenancy;
using Acme.EMS.Web.Menus;
...
public class EMSWebModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<EMSDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Acme.EMS.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<EMSDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Acme.EMS.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<EMSApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Acme.EMS.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<EMSApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Acme.EMS.Application"));
